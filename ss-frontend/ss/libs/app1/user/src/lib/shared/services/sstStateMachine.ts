...
import { InterpretedService, UseMachineOptions } from './sstStateMachineTypes';

@Injectable()
export class SstStateMachine<
  TContext,
  TStateSchema,
  ...
  private readonly unsubscribe$ = this.unsubscribeSubject$.asObservable();
